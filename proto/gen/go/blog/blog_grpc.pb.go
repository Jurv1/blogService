...
const (
	UserService_MakeMutation_FullMethodName = "/blog.UserService/MakeMutation"
)
...
type UserServiceClient interface {
	MakeMutation(ctx context.Context, in *MakeMutationRequest, opts ...grpc.CallOption) (*MakeMutationResponse, error)
}
...
func (c *userServiceClient) MakeMutation(ctx context.Context, in *MakeMutationRequest, opts ...grpc.CallOption) (*MakeMutationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MakeMutationResponse)
	err := c.cc.Invoke(ctx, UserService_MakeMutation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	MakeMutation(context.Context, *MakeMutationRequest) (*MakeMutationResponse, error)
...
func (UnimplementedUserServiceServer) MakeMutation(context.Context, *MakeMutationRequest) (*MakeMutationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MakeMutation not implemented")
}
...
func _UserService_MakeMutation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MakeMutationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).MakeMutation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_MakeMutation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).MakeMutation(ctx, req.(*MakeMutationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "MakeMutation",
			Handler:    _UserService_MakeMutation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "blog.proto",
